...
const composeHexPayload = ({ payload, nonce }: { payload: Uint8Array; nonce: number }) => {
	const SEED = Uint8Array.from([
		226, 172, 78, 86, 136, 217, 100, 39, 10, 216, 118, 215, 96, 194, 235, 178, 213, 79, 178,
		109, 147, 81, 44, 121, 0, 73, 182, 88, 55, 48, 208, 111,
	]);
