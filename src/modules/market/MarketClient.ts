...
export class MarketClient extends BaseHttpClient {
	...
	async getMarkPriceKline(params: GetMarkPriceKlineParams): Promise<GetPriceKlineResponse> {
		return this.request<GetPriceKlineResponse>(
	...
	async getOpenInterest(params: GetOpenInterestParams): Promise<GetOpenInterestResponse> {
		return this.request<GetOpenInterestResponse>(
	...
	async getLongShortRatio(params: GetLongShortRatioParams): Promise<GetLongShortRatioResponse> {
		return this.request<GetLongShortRatioResponse>(
	...
	async getStats(params: GetStatsParams): Promise<GetStatsResponse> {
		return this.request<GetStatsResponse>("/market/stats", {}, { query: params });
	}

	async getStatsVolume(params: GetStatsVolumeParams): Promise<GetStatsVolumeResponse> {
		return this.request<GetStatsVolumeResponse>(
			"/market/stats/volume",
			{},
			{ query: params }
		);
